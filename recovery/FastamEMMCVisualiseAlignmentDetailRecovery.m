function [sorted_interventions, max_points] = FastamEMMCVisualiseAlignmentDetailRecovery(amIntrNormcube, amHeldBackcube, amInterventions, meancurvemean, ...
...
for n = 1:nlatentcurves
    ...
    if tmp_ninterventions ~= 0 
        [tmp_sorted_interventions, max_points(n, :)] = FastamEMVisualiseAlignmentDetailRecovery(amIntrNormcube(tmp_idx, :, :), ... 
