...
[amInterventions] = amEMMCCalcAbsPredAndBounds(amInterventions, recovery_start, nlatentcurves);
...
save(fullfile(basedir, subfolder, outputfilename), 'amDatacube', 'amIntrDatacube', 'amIntrNormcube', ...
    ...
    'study', 'mversion', 'treatgap', 'testlabelmthd', 'sigmamethod','offset', 'align_wind', 'ex_start', 'confidencethreshold', ...
