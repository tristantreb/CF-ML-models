function plotSuperimposedAlignedCurvesForPaperRecovery(ax, meancurvemean, xl, yl, ...
    tmpmeasures, tmpnmeasures, offset, align_wind, ex_start, study)
...
for m = 1:tmpnmeasures
    ...
    lstyle = '-';
    lwidth = 1.5;
    [xl, yl] = plotLatentCurve(ax, offset, align_wind, meancurvemean(:, tmpmeasures.Index(m)), xl, yl, thiscolour, lstyle, lwidth, anchor);
end
