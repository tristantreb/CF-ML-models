function [amImputedCube, imputedscore] = RamEMMCCalcImputedProbabilities(amIntrCube, amHeldBackcube, ...
        meancurvemean, meancurvestd, normstd, overall_pdoffset, offset, align_wind, nmeasures, ...
...
tempmean = zeros(nlatentcurves, align_wind + offset.span-1, nmeasures);
tempstd  = zeros(nlatentcurves, align_wind + offset.span-1, nmeasures);
amImputedCube = zeros(ninterventions, align_wind + offset.span-1, nmeasures);
...
% not updated because used imputationmode 1
if imputationmode == 2
