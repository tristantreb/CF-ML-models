function [amInterventions] = RamEMMCCalcAbsPredAndBounds(amInterventions, ex_start, nlatentcurves)
...
% %twoconfidx = amInterventions.LowerBound2 ~= -1;amInterventions.RelLB2(twoconfidx) = amInterventions.IVScaledDateNum(twoconfidx) ...
