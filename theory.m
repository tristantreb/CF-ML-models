...
diff_std_coef_down = [diff(std_coef_down); nan];
diff_std_coef_up = [diff(std_coef_up); nan];
disp(table(n,std_coef_down,diff_std_coef_down,std_coef_up,diff_std_coef_up));
